...
export default function SamsungPage({
  ...
  const [channels] = useState<Channel[]>(SAMSUNG_TV_PLUS_CHANNELS);
  const [selectedChannel, setSelectedChannel] = useState<Channel | null>(
    SAMSUNG_TV_PLUS_CHANNELS[0] || null,
  );
  ...
  const getPlayableUrl = (url: string) => {
    if (!url) return "";
    return `/api/proxy/stream?url=${encodeURIComponent(url)}&referer=${encodeURIComponent("https://samsungtvplus.com/")}`;
  };
  ...
  return (
    <div className="min-h-screen bg-[#070707] text-white flex flex-col relative overflow-hidden font-sans">
      ...
      <div className="absolute top-[-20%] left-[-10%] w-[900px] h-[900px] bg-blue-600/10 rounded-full blur-[180px] pointer-events-none animate-pulse duration-[8000ms]" />
      <div className="absolute bottom-[-15%] right-[-10%] w-[800px] h-[800px] bg-sky-600/5 rounded-full blur-[160px] pointer-events-none" />
        ...
        {loading && (
          ...
          >
            <div className="relative">
              <div className="w-24 h-24 rounded-full border-4 border-t-blue-500 border-r-sky-500 border-b-blue-300 border-l-transparent animate-spin" />
            ...
            <div className="text-center space-y-2">
              <h2 className="text-2xl font-black uppercase tracking-widest italic">
                SAMSUNG <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-sky-500">TV+</span>
              </h2>
        ...
        <div className="flex items-center gap-4 w-full sm:w-auto">
          ...
          <div className="flex items-center gap-3">
            <h1 className="text-xl md:text-2xl font-black tracking-[-0.05em] italic uppercase leading-none">
              SAMSUNG <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-sky-500 drop-shadow-md">TV+</span>
            </h1>
            <div className="bg-white/5 border border-white/10 px-2 py-0.5 rounded text-[9px] font-black tracking-widest text-blue-400 uppercase">
              Free Live TV
            </div>
          </div>
        </div>
                ...
                return (
                  <div 
                    ...
                    className={cn(
                      ...
                      isSelected 
                        ? "border-blue-500/50 bg-blue-950/10 shadow-[0_8px_30px_rgb(59,130,246,0.15)]" 
                ...
                {isVideoLoading && (
                  <div className="absolute inset-0 bg-black/70 backdrop-blur-[2px] flex flex-col items-center justify-center gap-3 z-10 pointer-events-none">
                    <div className="relative flex items-center justify-center">
                      ...
                      <span className="absolute text-[10px] font-black italic text-blue-400">S+</span>
                    </div>
              ...
              <div className="p-6 md:p-8 flex-1 flex flex-col justify-start">
                <div className="flex items-start gap-5">
                  ...
                  <div className="flex-1 min-w-0">
                    <span className="bg-blue-500/20 text-blue-400 px-2 py-0.5 rounded text-[10px] font-black uppercase tracking-widest mb-2 inline-block">
                      {selectedChannel.category || 'Samsung TV+'}
                    </span>
                ...
                <div className="mt-8">
                  <button
                    ...
                    className="w-full py-4 bg-blue-600 hover:bg-blue-500 text-white font-black rounded-2xl transition-all active:scale-95 shadow-lg shadow-blue-600/20 flex items-center justify-center gap-3 uppercase tracking-widest text-xs"
                  >
